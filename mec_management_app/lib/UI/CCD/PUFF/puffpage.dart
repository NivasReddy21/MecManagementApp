import 'package:mec_management_app/UI/CCD/PUFF/detailspage.dart';
import 'package:flutter/material.dart';
import 'dart:ui';

class PUFF extends StatefulWidget {
  @override
  _PUFFPageState createState() => _PUFFPageState();
}

class _PUFFPageState extends State<PUFF> {
  @override
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Container(
                height: 125.0,
                child: ListView(scrollDirection: Axis.horizontal, children: [
                  _buildImage('assets/img/puff.jpg'),
                  _buildImage('assets/img/burger.jpg'),
                  _buildImage('assets/img/puff2.jpg')
                ])),
