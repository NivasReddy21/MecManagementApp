...
import 'package:mec_management_app/UI/CCD/maggi/detailspage.dart';
import 'dart:ui';

class MAGGI extends StatefulWidget {
  @override
  _MAGGIPageState createState() => _MAGGIPageState();
}

class _MAGGIPageState extends State<MAGGI> {
  @override
