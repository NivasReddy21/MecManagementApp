import 'package:mec_management_app/UI/holidays.dart';
import 'package:mec_management_app/UI/holidays/holidays_detail_screen.dart';
import 'package:mec_management_app/styleguide.dart';
      ...
      onTap: () {
        Navigator.push(
            ...
            PageRouteBuilder(
                ...
                pageBuilder: (context, _, __) => HolidayDetailScreen(character: character)));
      },
